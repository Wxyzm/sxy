...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if ([self.delegate respondsToSelector:@selector(cycleScrollView:starScrollWIthIndex:)]) {
        [self.delegate cycleScrollView:self starScrollWIthIndex:indexOnPageControl];
    }
...
- (void)scrollViewDidEndScrollingAnimation:(UIScrollView *)scrollView
{
    ...
    SDCollectionViewCell *cell = (SDCollectionViewCell*)[_mainView cellForItemAtIndexPath:indexpath];
    if (cell.imageView.image) {
        if ([self.delegate respondsToSelector:@selector(cycleScrollView:didSelectedCurrentImage:)]) {
            [self.delegate cycleScrollView:self didSelectedCurrentImage:cell.imageView.image];
        }
    }
