...
@interface CreateGoodsController ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate,UITextViewDelegate>
...
@implementation CreateGoodsController{
...
- (void)UPALLinfoWithFaceImageUrl:(NSString *)faceImaStr andDetailImageStr:(NSString *)deImaStr{
    ...
    NSDictionary *dic = @{@"particularsPicture":deImaStr,
